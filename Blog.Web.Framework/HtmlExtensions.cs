...
namespace Blog.Web.Framework
{
    public static class HtmlExtensions
    {
        ...
        public static MvcHtmlString DeleteConfirmation<T>(this HtmlHelper<T> helper, string buttonsSelector) where T : BaseOsusEntityModel
        {
        ...
        public static MvcHtmlString DeleteConfirmation<T>(this HtmlHelper<T> helper, string actionName,
            string buttonsSelector) where T : BaseOsusEntityModel
        {
                ...
                Expression<Func<TModel, TValue>> expression, bool displayHint = true)
        {
            ...
            if (metadata.AdditionalValues.TryGetValue("OsusResourceDisplayName", out value))
            {
                var resourceDisplayName = value as OsusResourceDisplayName;
