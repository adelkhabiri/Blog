...
namespace Blog.Services.ExportImport
{
    ...
    public partial class ImportManager : IImportManager
    {
        ...
        //        if (worksheet == null)
        //            throw new ERP.xception("No worksheet found");
        ...
        //            }
        //            else
        //                throw new OsusException("Wrong file format");
        ...
        //        var worksheet = xlPackage.Workbook.Worksheets.FirstOrDefault();
        //        if (worksheet == null)
        //            throw new OsusException("No worksheet found");
