            ...
            using (var stream = new MemoryStream())
            {
                ...
                using (var xlPackage = new ExcelPackage(stream))
                {
                    ...
                    foreach (var items in itemsToExport)
                    {
                        ...
                        manager.WriteToXlsx(worksheet, row++, false/*_catalogSettings.ExportImportUseDropdownlistsForAssociatedEntities*/, fWorksheet: fWorksheet);
                    }
