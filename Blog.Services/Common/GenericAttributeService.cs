...
namespace Blog.Services.Common
{
    /// <summary>
    ...
    public partial class GenericAttributeService : IGenericAttributeService
    {
        ...
        /// {1} : key group
        /// </remarks>
        private const string GENERICATTRIBUTE_KEY = "Osus.genericattribute.{0}-{1}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string GENERICATTRIBUTE_PATTERN_KEY = "Osus.genericattribute.";
        #endregion
