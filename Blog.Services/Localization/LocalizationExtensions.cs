...
namespace Blog.Services.Localization
{
    public static class LocalizationExtensions
    {
            ...
            where T : BaseEntity, ILocalizedEntity
        {
            ...
            return GetLocalized(entity, keySelector, /*workContext.WorkingLanguage.Id*/1);
        }
        /// <summary>
        /// Get localized property of an entity
        /// </summary>
            ...
            where T : struct
        {
            ...
            return GetLocalizedEnum(enumValue, localizationService, /*workContext.WorkingLanguage.Id*/1);
        }
        /// <summary>
        /// Get localized value of enum
        /// </summary>
