...
//using Blog.Core.Domain.Forums;
//using Blog.Core.Domain.News;
//using Blog.Core.Domain.Orders;
//using Blog.Core.Domain.Polls;
//using Blog.Core.Domain.Shipping;
using Blog.Data;
...
namespace Blog.Services.Customers
{
    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        /// </remarks>
        private const string CUSTOMERROLES_ALL_KEY = "Osus.customerrole.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : system name
        /// </remarks>
        private const string CUSTOMERROLES_BY_SYSTEMNAME_KEY = "Osus.customerrole.systemname-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string CUSTOMERROLES_PATTERN_KEY = "Osus.customerrole.";
        ...
        public virtual void DeleteCustomer(Customer customer)
        {
            ...
            if (customer.IsSystemAccount)
                throw new OsusException(string.Format("System customer account ({0}) could not be deleted", customer.SystemName));
        ...
        public virtual Customer InsertGuestCustomer()
        {
            ...
            if (guestRole == null)
                throw new OsusException("'Guests' role could not be loaded");
        ...
        public virtual void DeleteCustomerRole(CustomerRole customerRole)
        {
            ...
            if (customerRole.IsSystemRole)
                throw new OsusException("System role could not be deleted");
