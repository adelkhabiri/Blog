...
//using Blog.Web.Infrastructure.Cache;
...
namespace Blog.Web.Factories
{
    ...
    public partial class BlogModelFactory : IBlogModelFactory
    {
        ...
        public virtual void PrepareBlogPostModel(BlogPostModel model, BlogPost blogPost, bool prepareComments)
        {
            ...
            model.SeName = blogPost.Title.Replace(" ","-") /*blogPost.GetSeName(blogPost.LanguageId, ensureTwoPublishedLanguages: false)*/;
            ...
            model.NumberOfComments = _blogService.GetBlogCommentsCount(blogPost, 1, true);
        ...
        public virtual BlogPostListModel PrepareBlogPostListModel(BlogPagingFilteringModel command)
        {
            ...
            {
                blogPosts = _blogService.GetAllBlogPosts(1,
                    _workContext.WorkingLanguage.Id,
                    dateFrom, dateTo, command.PageNumber - 1, command.PageSize);
            }
            else
            {
                blogPosts = _blogService.GetAllBlogPostsByTag(1,
                    _workContext.WorkingLanguage.Id,
        ...
        //        //get tags
        //        var tags = _blogService.GetAllBlogPostTags(1, _workContext.WorkingLanguage.Id)
