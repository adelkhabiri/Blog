     ...
     //   private readonly IPermissionService _permissionService;
        ...
        public virtual ActionResult Create(CountryModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("ERP.Configuration.Countries.Added"));
        ...
        public virtual ActionResult Edit(CountryModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("ERP.Configuration.Countries.Updated"));
        ...
        public virtual ActionResult Delete(int id)
        {
            ...
            try
            {
                ...
                SuccessNotification(_localizationService.GetResource("ERP.Configuration.Countries.Deleted"));
                return RedirectToAction("List");
            }
            catch (Exception exc)
            {
        ...
        public virtual ActionResult StateDelete(int id)
        {
            ...
            //{
            //    return Json(new DataSourceResult { Errors = _localizationService.GetResource("ERP.Configuration.Countries.States.CantDeleteWithAddresses") });
            //}
            ...
            bool? addSelectStateItem, bool? addAsterisk)
        {
            ...
            else
            {
                if (country == null)
                {
                    ...
                    {
                        result.Insert(0, new { id = 0, name = _localizationService.GetResource("ERP.Address.SelectState") });
                    }
                    else
                    {
                        result.Insert(0, new { id = 0, name = _localizationService.GetResource("ERP.Address.OtherNonUS") });
                    }
                }
                else
                {
