...
namespace Blog.Core.Infrastructure
{
    ...
    /// Engine
    /// </summary>
    public class OsusEngine : IEngine
    {
        #region Fields
        ...
        protected virtual void RegisterDependencies(OsusConfig config)
        {
            var builder = new ContainerBuilder();
            
            //dependencies
            var typeFinder = new WebAppTypeFinder();
            builder.RegisterInstance(config).As<OsusConfig>().SingleInstance();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        protected virtual void RegisterMapperConfiguration(OsusConfig config)
        {
            //dependencies
            var typeFinder = new WebAppTypeFinder();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        public void Initialize(OsusConfig config)
        {
            //register dependencies
