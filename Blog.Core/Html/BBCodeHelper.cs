...
using Blog.Core.Html.CodeFormatter;
using Blog.Core.Infrastructure;

namespace Blog.Core.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                var newWindow = false;//EngineContext.Current.Resolve<CommonSettings>().BbcodeEditorOpenLinksInNewWindow;
