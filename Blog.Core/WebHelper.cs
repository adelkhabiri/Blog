    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual string GetStoreHost(bool useSsl)
        {
            ...
            if (DataSettingsHelper.DatabaseIsInstalled())
            {
                ...
                var storeContext = EngineContext.Current.Resolve<IBranchContext>();
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false, string redirectUrl = "")
        {
            ...
            else
            {
                ...
                if (!success)
                {
                    throw new OsusException("nopCommerce needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContext.Items["Osus.IsPOSTBeingDone"] == null)
                    return false;
                return Convert.ToBoolean(_httpContext.Items["Osus.IsPOSTBeingDone"]);
            }
            set
            {
                _httpContext.Items["Osus.IsPOSTBeingDone"] = value;
            }
        }
